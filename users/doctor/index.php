...
if (isset($_POST['diseases'], $_POST['height'], $_POST['weight'])) {
 $stmt = $conn->prepare("INSERT INTO doctor_reports (patient_id, diseases, allergies, blood_group, chronic_illnesses, past_surgeries, family_history, height, weight, symptoms, diagnosis, prescriptions, prescribed_medicines, test_status) 
                        VALUES (:patient_id, :diseases, :allergies, :blood_group, :chronic_illnesses, :past_surgeries, :family_history, :height, :weight, :symptoms, :diagnosis, :prescriptions, :prescribed_medicines, :test_status)");
...
$stmt->execute([
    ...
    'chronic_illnesses' => $_POST['chronic_illnesses'],
    'past_surgeries' => $_POST['past_surgery'],
        ...
        <div class="view-section">
            <div class="patient-details">
                ...
                <?php
                    ...
                    $imagePath = $patientDetails['dp'];
                ?>
                <img src="../../uploads/<?= $imagePath ?>" alt="../../uploads/<?= $patientDetails['dp']?> "    class="patient-image">
            ...
            <div class="register-details">
                <form method="POST" action="">
                    ...
                    <input type="text" name="chronic_illnesses" placeholder="Chronic Illnesses">
